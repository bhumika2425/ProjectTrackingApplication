        ...
        <div class="d-flex justify-content-center align-items-center mt-3">
            <div class="card shadow-lg p-4" style="max-width: 400px; width: 100%; border-radius: 12px; background-color: #f3f4f6;">
                <div class="card-header text-center" style="background-color: transparent; border-bottom: none;">
                    <h4 class="mb-0" style="color: #374151;">Project Details</h4>
                </div>
                <div class="card-body">
                    <asp:Panel ID="UserFormPanel" runat="server">
                        <!-- Project ID Section -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b5563;">Project ID:</label>
                            <asp:TextBox ID="txtProjectID" runat="server" CssClass="form-control" required="true" style="width: 100%; max-width: 400px; border-radius: 8px;" />
                        </div>

                        <!-- Project Name Section -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b5563;">Project Name:</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b5563;">Project Start Date:</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b5563;">Project Due Date:</label>
                        ...
                        <!-- Project Status Section with Dropdown Icon -->
                        <div class="mb-3">
                            <label class="form-label fw-bold" style="color: #4b5563;">Project Status:</label>
